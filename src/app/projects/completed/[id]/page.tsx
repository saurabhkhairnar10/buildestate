    ...
    <main className="min-h-screen bg-white pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
          {[
            { label: "Completion Date", value: project.completionDate, icon: <Calendar size={20} className="text-amber-600" /> },
            { label: "Total Units", value: project.units, icon: <CheckCircle size={20} className="text-green-600" /> },
            { label: "Status", value: "Sold Out", icon: <CheckCircle size={20} className="text-green-600" /> },
