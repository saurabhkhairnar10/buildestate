    ...
    <main className="min-h-screen bg-white pt-20">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-12">
          {[
            { label: "Launch Date", value: project.launch, icon: <Clock size={20} className="text-amber-600" /> },
            { label: "Project Type", value: project.type, icon: <CheckCircle size={20} className="text-green-600" /> },
        ...
        <div className="bg-amber-50 rounded-2xl p-8 text-center">
          <h3 className="text-2xl font-bold text-gray-800 mb-2">Register for Pre-Launch Pricing</h3>
          <p className="text-gray-500 mb-6">Be the first to know — get exclusive pre-launch offers</p>
